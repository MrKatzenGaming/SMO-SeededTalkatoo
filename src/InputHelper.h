...
public:
    ...
    static float getLeftStickRight() {
        float x = getLeftStickX();
        return x > 0 ? x : 0;
    }

    static float getLeftStickUp() {
        float y = getLeftStickY();
        return y > 0 ? y : 0;
    }

    static float getLeftStickDown() {
        float y = getLeftStickY();
        return y < 0 ? -y : 0;
    }
    ...
    static float getRightStickRight() {
        float x = getRightStickX();
        return x > 0 ? x : 0;
    }

    static float getRightStickUp() {
        float y = getRightStickY();
        return y > 0 ? y : 0;
    }

    static float getRightStickDown() {
        float y = getRightStickY();
        return y < 0 ? -y : 0;
    }
